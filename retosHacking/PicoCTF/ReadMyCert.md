...
¿Qué tal si te llevamos de viaje a explorar solicitudes de firma de certificadosEcha un vistazo a este archivo [CSR aquí](https://artifacts.picoctf.net/c/420/readmycert.csr).
### solucion
```
